...
# Class names.
#class_names = ['FreshApple', 'FreshMango', 'FreshStrawberry', 'RottenBanana', 'RottenOrange', 'FreshBanana', 'FreshOrange', 'RottenApple', 'RottenMango', 'RottenStrawberry']
class_names = ['FreshApple', 'FreshBanana', 'FreshMango', 'FreshOrange', 'FreshStrawberry', 'RottenApple', 'RottenBanana', 'RottenMango', 'RottenOrange', 'RottenStrawberry']
